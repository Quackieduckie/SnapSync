...
def get_system_stats():
    ...
    # Format network value without right alignment
    net_value = f"{net_load:.2f} MB"
...
def display_stats(epd):
    ...
    net_below_area = (bar_x, header_height + 152, value_x + 40, header_height + 172)  # Adjusted width
